...
public class CiSpyRole : ExternalRoleChecker
{
    ...
    public override ExternalRoleType IsRole(Player player)
    {
        ...
        if (isSpyMethod == null)
        {
            Log.Error("CiSpy API method IsSpy not found.");
            return ExternalRoleType.None;
        }
        ...
        {
            Log.Error("CiSpy API method GetNtfSpyList not found.");
            return ExternalRoleType.None;
        }
        
        if (isChaosSpyMethod == null)
        {
            Log.Error("CiSpy API method GetChaosSpyList not found.");
            return ExternalRoleType.None;
        }
    ...
    public override void SpawnRole(Player newPlayer, ExternalRoleType extenalRole)
    {
        ...
        if (extenalRole == ExternalRoleType.NtfSpy)
        {
            ...
            {
                Log.Error("CiSpy API method GetSpawnNtfSpy not found.");
                return;
            }
        ...
        else if (extenalRole == ExternalRoleType.ChaosSpy)
        {
            ...
            {
                Log.Error("CiSpy API method GetSpawnChaosSpy not found.");
                return;
            }
